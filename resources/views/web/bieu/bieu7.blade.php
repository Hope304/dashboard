<h4 class="bangdieukhien text-center">BIỂU 7: TRỮ LƯỢNG RỪNG TRỒNG PHÂN THEO LOÀI CÂY CẤP TUỔI</h4>
<div class="form-check table-responsive">
    <table class="table table-bordered table-sm">
        ...
        <tr class="active">
            ...
            <th scope="col" rowspan="2" class="text-center">Tổng trữ <br/>lượng rừng trồng</th>
            <th scope="col" colspan="6" class="text-center">Trữ lượng đã thành rừng phân theo cấp tuổi</th>
        </tr>
        <tr class="active">
