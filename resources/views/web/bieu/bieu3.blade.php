<h4 class="bangdieukhien text-center">BIỂU 3: DIỆN TÍCH RỪNG VÀ ĐẤT LÂM NGHIỆP PHÂN THEO CHỦ QUẢN LÝ</h4>
<div class="form-check table-responsive">
    <table class="table table-bordered table-sm">
        ...
        <tr class="active">
            ...
            <th scope="col" class="text-center">Tổng <br/>diện tích</th>
