<h4 class="bangdieukhien text-center">BIỂU 2: TRỮ LƯỢNG CÁC LOẠI RỪNG VÀ ĐẤT LÂM NGHIỆP PHÂN THEO MỤC ĐÍCH SỬ DỤNG</h4>
<div class="form-check table-responsive">
    <table class="table table-bordered table-sm">
        ...
        <tr class="active">
            ...
            <th scope="col" rowspan="2" class="text-center">Đơn <br/>vị tính</th>
            <th scope="col" rowspan="2" class="text-center">Tổng <br/>trữ lượng</th>
            <th scope="col" rowspan="2" class="text-center">Trữ lượng <br/>trong quy hoạch</th>
            ...
            <th scope="col" rowspan="2" class="text-center">Rừng ngoài đất quy hoạch <br/>dành cho lâm nghiệp</th>
        </tr>
        <tr class="active">
            <th scope="col" class="text-center">Cộng</th>
            <th scope="col" class="text-center">Vườn <br/>quốc gia</th>
            <th scope="col" class="text-center">Khu bảo <br/>tồn thiên nhiên</th>
