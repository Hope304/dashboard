...
class WeatherController extends Controller
{
    public function getIndex()
    {
        ...
        foreach ($listCommune as $list) {
            ...
            $time_now = date('Y-m-d');
            /* Key WetherAPI: 52c5d1af35ed4622b7b72412232011 */
            $url_now = "http://api.weatherapi.com/v1/history.json?key=52c5d1af35ed4622b7b72412232011&q=" . trim($list->vd) . "," . trim($list->kd) . "&dt=" . $time_now;
            ...
            $url_ago = "http://api.weatherapi.com/v1/history.json?key=52c5d1af35ed4622b7b72412232011&q=" . trim($list->vd) . "," . trim($list->kd) . "&dt=" . $date_ago;
